...
ActiveRecord::Schema.define(version: 20_230_521_163_758) do
  ...
  create_table 'sales', force: :cascade do |t|
    ...
    t.integer 'amount'
    t.integer 'creator_affiliated_id_id', null: false
    t.integer 'transaction_type_id_id', null: false
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index ['creator_affiliated_id_id'], name: 'index_sales_on_creator_affiliated_id_id'
    t.index ['id'], name: 'index_sales_on_id', unique: true
    t.index ['product_id_id'], name: 'index_sales_on_product_id_id'
    t.index ['transaction_type_id_id'], name: 'index_sales_on_transaction_type_id_id'
  end
