...
productor1 = Productor.create!(name: 'JOSE CARLOS', email: 'jose_carlos@gmail.com', balance: 0, password: '123456')
productor2 = Productor.create!(name: 'ELIANA NOGUEIRA', email: 'eliana@gmail.com', balance: 0, password: '123456')
productor3 = Productor.create!(name: 'MARIA CANDIDA', email: 'candida@gmail.com', balance: 0, password: '123456')
...
affiliated1 = Affiliated.create!(name: 'THIAGO OLIVEIRA', email: 'thiago@gmail.com', balance: 0, productor_id: productor1.id, password: '123456')
affiliated2 = Affiliated.create!(name: 'CELSO DE MELO', email: 'celso@gmail.com', balance: 0, productor_id: productor2.id, password: '123456')
affiliated3 = Affiliated.create!(name: 'CARLOS BATISTA', email: 'carlos@gmail.com', balance: 0, productor_id: productor2.id, password: '123456')
affiliated4 = Affiliated.create!(name: 'CAROLINA MACHADO', email: 'carolina@gmail.com', balance: 0, productor_id: productor2.id, password: '123456')
