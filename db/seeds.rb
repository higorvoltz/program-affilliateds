...
client1 = Client.create!(name: 'CARLOS MIGUEL', email: 'carlos@gmail.com', balance: 99_999_999_999, password: '123456')
client2 = Client.create!(name: 'ADALBERTO PESSANHA', email: 'dada@gmail.com', balance: 99_999_999_999, password: '123456')
client3 = Client.create!(name: 'SILVIO SANTOS', email: 'silvio@gmail.com', balance: 99_999_999_999, password: '123456')

ProductRanking.create!(ranking: 5, product_id: product1.id, client_id: client1.id)
ProductRanking.create!(ranking: 4, product_id: product2.id, client_id: client2.id)
ProductRanking.create!(ranking: 3, product_id: product3.id, client_id: client3.id)
